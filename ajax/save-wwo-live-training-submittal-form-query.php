           ...
           // print_r("Inside Else");
            ...
            if ($check_email_exist->num_rows > 0) {
                ...
                if ($insert) {
                    ...
                    $formPDF = $mpdf->Output('./../pdfs/wwo-live-training-submittal-form-pdfs/wwo-live-training-submittal-form-'.$firstName.'-'.time().'.pdf','F');
    
                    $formPDFMail = $mpdf->Output('wwo-live-training-submittal-form-'.$firstName.'-'.time().'.pdf','S');
