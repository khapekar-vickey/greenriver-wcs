<?php
/*
  Template Name: Backflow Assembly Testers Sub Pages
 */
/**
        ...
        <div class="container">
            ...
            <div class="row flex-row text-grey pb-5">
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <?php if (have_rows('sidebar_components_bat', 'option')):
                        while (have_rows('sidebar_components_bat', 'option')): the_row();
                            ...
                            <div class="single-info-box d-flex align-items-center pt-4">
                                ...
                                <?php while( have_rows('svg_icons','option') ): the_row(); 
                                      ...
                                      // append icon
                                      //if( $svgIcon ):?>
                                <svg class="aaaaa <?php echo $svgIconClass; ?>" viewBox="<?php echo $svgIconViewBox; ?>">
            ...
            ?>
            <a href="<?php echo esc_url( $addLinkToImage_url ); ?>" target="<?php echo esc_attr( $addLinkToImage_target ); ?>" tabindex="0">
        <?php endif; ?>
            ...
            ?></a><?php endif; ?>
                            ...
                            <?php
                            /*
                             elseif (get_row_layout() == 'add_working_hours'):
