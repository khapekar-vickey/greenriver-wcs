<?php // The template part for displaying the footer of the website ?>
          ...
          <div class="container footer-copyright">
            <!-- <p>
              Copyright © 2020 Washington Certification Services. All Rights
              Reserved
            </p> -->
            <ul>
<!--                 <li><a href="#">Disability Accommodation Policy</a></li> -->
                <?php echo do_shortcode('[BATPageFooterLink]')?> 
                <li class="c2">Copyright © <?php echo date("Y"); ?> Washington Certification Services. All Rights Reserved</li>
