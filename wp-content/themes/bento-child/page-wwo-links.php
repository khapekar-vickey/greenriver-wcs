      ...
      <div class="container">
        <div class="row banner-content mhB-225">
          ...
          <?php $category = get_the_category();
            $category_parent_id = $category[1]->category_parent;
            $category_parent = get_category($category_parent_id);
            //echo "<pre>"; print_r($category_parent);exit;
           ?>
      ...
      <div class="container">
        <div class="row flex-row-reverse text-grey pb-5">
          <div class="col-12 col-md-7 col-lg-8">
            <div class="asd sec-title-wrap">
            <?php
            $myposts = wwo_links_posts('');
                foreach ($myposts as $post) :
                setup_postdata($post);
            ?>	
            <?php $img = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), "size" ); ?>
              <h2 class="asdsdd sec-title font-segoe-b">
