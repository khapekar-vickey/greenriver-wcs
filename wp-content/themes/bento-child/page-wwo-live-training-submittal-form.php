<?php
/*
  Template Name: WWO Live Training Submittal Form
 */
/**
        ...
        <div class="container">
            <div class="row flex-row-reverse text-grey pb-5">
                <div class="col-12 col-md-8 col-lg-9">
                    ...
                    <form class="row" id="wwo-live-training-submittal-form" method="post">
                        ...
                        <div class="form-group col-md-6">
                            <label for="creditAwardedCourseSponsor" class="pl-3 col-form-label labelAlign">CEU/College
                                Credit Awarded by Course Sponsor (Required)</label>
                            <input type="text" class="form-control" id="creditAwardedCourseSponsor"
                                name="creditAwardedCourseSponsor">
                            <span id="creditAwardedCourseSponsor-info" class="text-danger float-right"></span>
                        </div>
                        <div class="col-12">
                            <hr>
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="certificateofCompletion">Certificate of completion
                                    or transcript verifying CEU/college credit awarded by course sponsor. If CEU has
                                    been awarded based on individual conference sessions attended, you must submit
                                    verification of specific sessions completed and CEU awarded for each session. You
                                    must also submit the additional information listed below for each conference
                                    session.</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="courseDescriptionOutline"
                                    name="courseDescriptionOutline">
                                <label class="form-check-label" for="courseDescriptionOutline">Course description,
                                    outline, or syllabus documenting how the training is directly related to the
                                    operation or maintenance of a water system, or to managing the operation or
                                    maintenance of a water system; and how it influences water quality, water supply or
                                    public health protection</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="addressDetails"
                                    name="addressDetails">
                                <label class="form-check-label" for="addressDetails">Name, address and phone number of
                                    course sponsor</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="courseTimeSchedule"
                                    name="courseTimeSchedule">
                                <label class="form-check-label" for="courseTimeSchedule">Course time schedule showing
                                    beginning and ending times of training and all scheduled breaks.</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="attendanceMonitoring"
                                    name="attendanceMonitoring">
                                <label class="form-check-label" for="attendanceMonitoring">Attendance monitoring
                                    declaration if course was completed remotely/ virtually.</label>
                            </div>
                        </div>
                    ...
                    <script>
                        (function($) {
                            ...
                            $(document).ready(function() {
                                ...
                                $("#wwo-live-training-submittal-form").validate({
                                    ...
                                    submitHandler: function(form) {
                                        $.ajax({
                                            url: "/ajax/save-wwo-live-training-submittal-form-query.php",
                                            method: "POST",
                                            data: {
                                                ...
                                                creditAwardedCourseSponsor: $("#creditAwardedCourseSponsor").val(),

                                                certificateofCompletion: $("#certificateofCompletion")[0].checked,
                                                courseDescriptionOutline: $("#courseDescriptionOutline")[0].checked,
                                                addressDetails: $("#addressDetails")[0].checked,
                                                courseTimeSchedule: $("#courseTimeSchedule")[0].checked,
                                                attendanceMonitoring: $("#attendanceMonitoring")[0].checked
                                            ...
                                            success: function(data) {
                                                if (data.status == "success") {
                                                    $("#wwo-live-training-submittal-form")[0].reset();
                                                    if (data.message) {
