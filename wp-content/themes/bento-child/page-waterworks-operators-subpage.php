...
<div class="site-main" role="main">
  ...
  <?php $category = get_the_category();
    ...
    <div class="container-fluid bg-f5 py-3 px-0" aria-label="container-section-3">
                    ...
                    <?php if (have_rows('sidebar_components', 'option')):
                        while (have_rows('sidebar_components', 'option')): the_row();
                            ...
                            <?php elseif (get_row_layout() == 'single_image'):
                                     ...
                                     $addLinkToImage = get_sub_field('add_link_to_image_wwo', 'option');
        ...
        <?php else: echo '<a href="/batalk-archives/" target="_blank">'; ?><?php endif; ?>
            ...
            <?php else: echo '</a>'; ?><?php endif; ?>
                            ...
                            <div class="working-hours-box bg-prime text-white py-4 px-5 mt-5">
                                ...
                                <?php endif; ?>
                                <?php if($workingHourTimings): echo $workingHourTimings; else: echo '<div class="timing font25 pt-3" style="font-size: 16px;">Weekdays : 6:30 – 18:00</div><div class="timing font25 pt-3 pb-4" style="font-size: 16px;">Weekend : 8:00 - 12:00</div>'; endif; ?>
                            </div>
                        -->
                            <?php
                                        ...
                                        <div class="card-default-bg card w-100 bg-form text-white text-center">
                                            ...
                                            <div class="top-btn-wrappers">
                                                ...
                                                <?php if($m06TopRightButton): 
                                                    ...
                                                    ?>
                                                    <a role="button" class="<?php if($m06TopRightButtonClass): echo $m06TopRightButtonClass; else: echo 'card-link font18 web-fill-in-btn'; endif;?>" href="<?php echo esc_url( $m06TopRightButton_url ); ?>" target="<?php echo esc_attr( $m06TopRightButton_target ); ?>" aria-label="Web <?php echo strip_tags($m06Title);?>">
                                            ...
                                            <?php endif; ?>
                                                ...
                                                <div class="btn-wrappers">
                                                    ...
                                                    <a role="button" class="<?php if($m06LeftButtonClass): echo $m06LeftButtonClass; else: echo 'card-link font18 fill-in-btn'; endif;?>"
                                                        href="<?php echo esc_url( $m06LeftButton_url ); ?>" target="<?php echo esc_attr( $m06LeftButton_target ); ?>" aria-label="Fill-In <?php echo strip_tags($m06Title);?>">
                                                    ...
                                                    <a role="button" class="<?php if($m06RightButtonClass): echo $m06RightButtonClass; else: echo 'card-link font18 fill-in-btn'; endif;?>"
                                                        href="<?php echo esc_url( $m06RightButton_url ); ?>" target="<?php echo esc_attr( $m06RightButton_target ); ?>" aria-label="Download <?php echo strip_tags($m06Title);?>">
