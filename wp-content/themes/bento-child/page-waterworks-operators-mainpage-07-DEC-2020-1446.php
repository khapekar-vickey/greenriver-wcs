...
<div class="site-main">
  ...
  <?php if( have_rows('hero_banner') ): ?>
    <div class="container-fluid main-banner mhB-340 banner banner-margin">
    ...
    <?php if( have_rows('wwo-mainlayouts') ): ?>
        <?php while( have_rows('wwo-mainlayouts') ): the_row(); ?>
            <?php if( get_row_layout() == 'section_main' ): 
                ...
                ?>
                <div class="<?php if($sectionMainClass): echo $sectionMainClass; else: echo 'container-fluid py-3 px-0'; endif; ?>">
                            ...
                            <li class="col-12 col-md-6 col-lg-4 px-2 pt-3 infoboxlist align-items-center">
                                ...
                                <?php endif; ?>
                                    <div class="infobox_inn d-flex align-items-center bg-white p-4 eq-height">
                                        <?php if( $svgIcon ):?>
                                        <svg class="<?php if($svgIconClass): echo $svgIconClass; else: echo 'svgicon w93px fill-prime'; endif; ?>" viewBox="<?php if($svgViewboxValue): echo $svgViewboxValue; else: echo '12 10 63 55'; endif; ?>">
                                        <use
                                        ...
                                        <<?php if($titleTagType): echo $titleTagType; else: echo 'h2'; endif; ?> class="ib_title sem-bold"><?php if($titleTagType): echo $title; endif; ?></<?php if($titleTagType): echo $titleTagType; else: echo 'h2'; endif; ?> >
                                        </div>
                                    </div>
                                <?php if( $addLink ):?>
                                </a>
