...
$welcomemessage = "<section id='skip-main' class='container service mt-3 home-page-service-p'>";
	...
	foreach ($myposts as $post) :
        ...
        $widget='';
        $welcomemessage .="<ul class='container d-flex flex-wrap justify-content-center text-center boxCont '>";
        $i = 1;
            foreach ($get_home_widget_posts as $post) :
                ...
                $welcomemessage .="<a href='". $permalink."' target='".$target."'>".$post->post_title." </a>";
                $welcomemessage .="</span>";
                $welcomemessage .="</li>";
                $i++;
            endforeach;
