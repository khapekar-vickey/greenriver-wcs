<?php
/*
  Template Name: TCS Live Training and Conference Evaluation
 */
/**
      ...
      <div class="container">
        <div class="row flex-row-reverse text-grey pb-5">
          <div class="col-12 col-md-7 col-lg-8">
            ...
            <?php
            $myposts = tcs_live_training_and_conference_evaluation_desc_posts('');
            ...
            $myposts = get_tcs_landing_page_widget_posts('');
                ...
                $class = '';
                 ...
                 if($current_url == $pageUrl){
                    $class = 'active';
                    //$src = site_url().'/wp-content/uploads/2020/11/noun_online-video_2485264-white.svg';
                }else{
                    $class = "";
                    //$src = $img[0];
                }
            ...
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center <?php echo $class?>" style="padding: 1.9rem 2rem !important" href="<?php echo $permalink; ?>">
                  <svg class="svgicon  icon-pgr" viewBox="0 8 65 52">
                    ...
                    <img class="img-fluid" src="<?php echo $src; ?>" alt="" style="padding-right:10px;width: 40px; <?php echo $style?>">
                  </svg>
