        ...
        <div class="row flex-row-reverse text-grey pb-5">
          ...
          <div class="col-12 col-md-7 col-lg-8">
            ...
            <p class="para2 col-sm-12">
              I have read, understand and followed the Department of Health's <a href="#">Distance Education Approval and Examination Procedure</a>. I certify that I personally monitored the examination/s for the following course on the dates listed, and the student named below completed it whithout assistance from any source except as listed in the  procedure.
            </p>
          <form class="para form-data col-sm-12">    
             <div class=" form-group ">
                <label for="studentName" class="col-sm-6 col-form-label labelAlign">Student Name <span class="printPleaseAlign">(Please Print)</span></label>
            ...
            <div class=" form-group">
                <label for="Course Sponser" class="col-sm-6 col-form-label labelAlign">Course Sponser</label>
            ...
            <div class=" form-group">
                <label for="examinationDate" class="col-sm-6 col-form-label labelAlign">Examination Date/s </label>
            ...
            <div class=" form-group">
                <label for="examinationLocation" class="col-sm-6 col-form-label labelAlign">Examination Location</label>
            ...
            <div class=" form-group">
                <label for="examMonitorName" class="col-sm-6 col-form-label labelAlign">Exam Monitor Name <span class="printPleaseAlign">(Please Print)</span></label>
            ...
            <div class=" form-group">
                <label for="relationship" class="col-sm-6 col-form-label labelAlign">Relationship to Student</label>
                <input type="text" class="form-control col-sm-10 monitorEmployee" id="relationship">
                <span id="courseTitle-info" class="text-danger float-right"></span>
            </div>
            <div class=" form-group ">
                <label for="examMonitorEmployee" class="col-sm-6 col-form-label labelAlign">Exam Monitor's Employer</label>
            ...
            <div class=" form-group">
                <label for="employerAddress" class="col-sm-6 col-form-label labelAlign">Employer Address</label>
            ...
            <div class="form-group">
              ...
              <input type="tel" class="col-sm-10 form-control" id="businessPhone" maxlength="10" required/>
            ...
            <!-- <form class="para form-data"> -->
              <p class="labelAlign col-md-12 para2">I have read, understand, and followed the Department of Health's <a href="#">
              Self-Placed Training Approval and Examination Procedure</a>.I certify that I personally completed the course listed above and that my was based solely on my own personal efforts. I also certify that I have personally completed the examination/s in the presence of the examination monitor listed above whitout assitance from any source except as listed in the procedure. </p>
            
              <div class="form-group ">
                <label for="studentDecName" class="col-sm-6 col-form-label labelAlign">Student Name <span class="printPleaseAlign">(Please Print)</span></label>
              ...
              <div class=" form-group">
                <label for="wwocertificationNumber" class="col-sm-10 col-form-label labelAlign">Washington Waterworks Operator Certification Number</label>
