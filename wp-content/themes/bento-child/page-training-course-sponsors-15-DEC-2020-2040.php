<?php
/*
  Template Name: Training Course Sponsors
 */
/**
...
<div class="site-main">
    ...
    <div class="container-fluid main-banner mhB-340 banner">
      <div class="banner-img"
        style="background: url('<?php echo site_url();?>/wp-content/uploads/2020/11/shutterstock_489209455-Copy.jpg') no-repeat center/ cover;"></div>
      <div class="container">
        <div class="row banner-content mhB-340">
          <div class="page-title-wrap py-4">
            <h1 class="page-title text-white" style="color:#0180a9 !important"><?php echo get_the_title();?></h1>
    ...
    <div class="container-fluid bg-f5 py-3">
      <div class="container">
        <div class="row text-grey">
            <?php
            $myposts = get_tcs_landing_page_desc_posts('');
    ...
    <div class="container-fluid bg-eb py-5">
      <div class="container">
        <ul class="row px-0 list-style-none infobox_row row-eq-heigh">
            ...
            <li class="col-12 col-md-6 col-lg-4 px-2 pt-3 infoboxlist align-items-center" style="flex: none;">
            <a href="<?php echo get_permalink($post->ID) ?>">
              <div class="infobox_inn d-flex align-items-center bg-white p-4 eq-height" style="height:80px">
                ...
                <img class="img-fluid subfrm-image" src="<?php echo $img[0]; ?>" alt="" style="padding-right:10px">
                 
                <div class="ib_content">
                  <h2 class="ib_title" style="font-weight: 600;"><?php echo $post->post_title; ?></h2>
                </div>
              </div>
            </a>
          </li>
        ...
        <div class="row px-0 pt-5 list-style-none infobox_row row-eq-heigh">
          <div class="col-12 col-md-12 col-lg-12 px-2 pt-3 infoboxlist align-items-center">
            ...
            <?php
                $myposts = tcs_landing_page_whats_new_posts('');
                    foreach ($myposts as $post) :
                    setup_postdata($post);
            ?>	
            <?php $img = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), "size" ); ?>
              <div class="ib_icon pr-md-5 pr-3 pb-4 pb-sm-1" style="width: 70px;overflow: hidden;height: 70px;">
                <!--<img class="img-fluid mw-144" src="assets/images/water-work-operator/whats-new-icon.png" alt="">-->
                <img class="img-fluid mw-144" src="<?php echo $img[0]; ?>" alt="" style="width: 55px;">
              </div>
              <div class="ib_content">
