<?php
/*
  Template Name: Water Works Operators Sub Pages
 */
/**
            ...
            <div class="row flex-row-reverse text-grey pb-5">
                        ...
                        <?php elseif( get_row_layout() == 'm05-accordion' ): 
                                ...
                                <?php while( have_rows('m05-accordion_items') ): the_row(); 
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="<?php echo $m05AccordionID; ?>heading<?php echo $accItemCount; ?>">
                                            <h4 class="mb-0">
                                                <button class="btn btn-link" aria-expanded="false" data-toggle="collapse" data-target="#<?php echo $m05AccordionID; ?>collapse<?php echo $accItemCount; ?>" aria-expanded="true"
                                        ...
                                        <div id="<?php echo $m05AccordionID; ?>collapse<?php echo $accItemCount; ?>" class="card-body-wrap collapse" aria-labelledby="<?php echo $m05AccordionID; ?>heading<?php echo $accItemCount; ?>" data-parent="#<?php echo $m05AccordionID; ?>">
                                            <div class="card-body">
                            ...
                            (function ($) {
                                $(document).ready(function () {
                                    $('.prime-accordion .card:first-child .card-header button').attr('aria-expanded','true');
                                        ...
                                        <div class="card-default-bg card w-100 bg-form text-white text-center">
                                            ...
                                            <div class="top-btn-wrappers">
                                                ...
                                                <?php if($m06TopRightButton): 
                                                    ...
                                                    ?>
                                                    <a class="<?php if($m06TopRightButtonClass): echo $m06TopRightButtonClass; else: echo 'card-link font18 web-fill-in-btn'; endif;?>" href="<?php echo esc_url( $m06TopRightButton_url ); ?>" target="<?php echo esc_attr( $m06TopRightButton_target ); ?>">
                                            ...
                                            <?php endif; ?>
                                                ...
                                                <div class="btn-wrappers">
                                                    ...
                                                    <a class="<?php if($m06LeftButtonClass): echo $m06LeftButtonClass; else: echo 'card-link font18 fill-in-btn'; endif;?>"
                                                        href="<?php echo esc_url( $m06LeftButton_url ); ?>" target="<?php echo esc_attr( $m06LeftButton_target ); ?>">
                                                    ...
                                                    <a class="<?php if($m06RightButtonClass): echo $m06RightButtonClass; else: echo 'card-link font18 fill-in-btn'; endif;?>"
                                                        href="<?php echo esc_url( $m06RightButton_url ); ?>" target="<?php echo esc_attr( $m06RightButton_target ); ?>">
                ...
                while (have_rows('sidebar_components', 'option')): the_row();
                    ...
                    <div class="working-hours-box bg-prime text-white py-4 px-5 mt-5">
                        ...
                        <?php endif; ?>
                        <?php if($workingHourTimings): echo $workingHourTimings; else: echo '<div class="timing font25 pt-3">Mon – Fri : 6:30 – 18:00</div><div class="timing font25 pt-3 pb-4">Weekend : 8.00 - 12:00</div>'; endif; ?>
                    </div>
                    <?php
