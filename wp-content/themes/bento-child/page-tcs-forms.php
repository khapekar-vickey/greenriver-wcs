...
get_header();
?>
<link rel="stylesheet" href="<?php echo site_url()?>/html-pages/Forms-Live Training Course/Forms-changes.css" />
<div class="site-main">
    <!-- Banner -->
        ...
        <div class="row flex-row-reverse text-grey pb-5">
          ...
          <div class="col-12 col-md-5 col-lg-4">
            ...
            <div class=" container live-content-footer ">
                ...
                <?php
            $myposts = tcs_approved_live_training_whats_new_posts('');
                foreach ($myposts as $post) :
                setup_postdata($post);
            ?>	
            <?php $img = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), "size" ); ?>
